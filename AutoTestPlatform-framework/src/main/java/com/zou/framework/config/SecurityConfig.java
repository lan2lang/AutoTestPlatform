package com.zou.framework.config;

import com.zou.framework.config.properties.PermitAllUrlProperties;
import com.zou.framework.security.filter.JwtAuthenticationTokenFilter;
import com.zou.framework.security.handle.AuthenticationEntryPointImpl;
import com.zou.framework.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity httpSecurity) throws Exception {
    ...
    httpSecurity
        ...
        .antMatchers("/login", "/register", "/captchaImage","/test/1")
        .permitAll()
        // 静态资源，可匿名访问
        .antMatchers(
